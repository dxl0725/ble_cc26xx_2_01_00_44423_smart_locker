...
//#define BLE_NVID_CHAR1                  0x05  //!< The Device's major
//#define BLE_NVID_CHAR2                  0x06  //!< The Device's minor
//#define BLE_NVID_CHAR3                  0x07  //!< The Device's interval
//#define BLE_NVID_CHAR5                  0x08  //!< The Device's txPower
//#define BLE_NVID_CHAR6                  0x09  //!< The Device's uuid
...
#define BLE_NVID_CHAR1                  0x81  //!< 
#define BLE_NVID_CHAR2                  0x82  //!< 
#define BLE_NVID_CHAR3                  0x83  //!< 
#define BLE_NVID_CHAR4                  0x84  //!< 
#define BLE_NVID_CHAR5                  0x85  //!< 
#define BLE_NVID_CHAR6                  0x86  //!< 
#define BLE_NVID_CHAR7                  0x87  //!< 
#define BLE_NVID_CHAR8                  0x88  //!< 
#define BLE_NVID_CHAR9                  0x89  //!< 
#define BLE_NVID_CHAR10                 0x8A  //!< 
