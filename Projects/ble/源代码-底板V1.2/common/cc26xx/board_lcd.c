...
#define TI_DRIVERS_LCD_AMOMCU




#ifdef TI_DRIVERS_LCD_AMOMCU
#include "stdio.h"
#include "string.h"
...
#define LCD_SCL GPIO_PIN_9       //SCLK  时钟 D0（SCLK）
#define LCD_SDA GPIO_PIN_10     //SDA   D1（MOSI） 数据
#define LCD_RST GPIO_PIN_4       //_RES  hardware reset   复位 
