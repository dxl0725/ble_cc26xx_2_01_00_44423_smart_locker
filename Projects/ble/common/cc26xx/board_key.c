...
//  PIN_setConfig(hKeyPins, PIN_BM_IRQ, Board_KEY_SELECT  | PIN_IRQ_POSEDGE);
//  PIN_setConfig(hKeyPins, PIN_BM_IRQ, Board_KEY_UP      | PIN_IRQ_POSEDGE);
//  PIN_setConfig(hKeyPins, PIN_BM_IRQ, Board_KEY_DOWN    | PIN_IRQ_POSEDGE);
//  PIN_setConfig(hKeyPins, PIN_BM_IRQ, Board_KEY_LEFT    | PIN_IRQ_POSEDGE);
//  PIN_setConfig(hKeyPins, PIN_BM_IRQ, Board_KEY_RIGHT   | PIN_IRQ_POSEDGE);
...
//  PIN_setConfig(hKeyPins, PIN_BM_IRQ, Board_KEY_BUTTON1    | PIN_IRQ_BOTHEDGES);
//  PIN_setConfig(hKeyPins, PIN_BM_IRQ, Board_KEY_BUTTON2   | PIN_IRQ_BOTHEDGES);
...
//  PIN_setConfig(hKeyPins, PINCC26XX_BM_WAKEUP, Board_KEY_BUTTON1 | PINCC26XX_WAKEUP_NEGEDGE);
//  PIN_setConfig(hKeyPins, PINCC26XX_BM_WAKEUP, Board_KEY_BUTTON2 | PINCC26XX_WAKEUP_NEGEDGE);
#endif
...
//  if ( PIN_getInputValue(Board_KEY_BUTTON1) == 0 )
//  {
//    keysPressed |= BUTTON1;
//  }
//  if ( PIN_getInputValue(Board_KEY_BUTTON2) == 0 )
//  {
//    keysPressed |= BUTTON2;
//  }
